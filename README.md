...
- **Forensic Evasion & OpSec**:
    - **Zero-Disk-Leakage**: Decryption streams directly through OS pipes (`|`) between the compiled V execution flow and the external `zstd` binary. Decrypted plaintext never touches the disk.
